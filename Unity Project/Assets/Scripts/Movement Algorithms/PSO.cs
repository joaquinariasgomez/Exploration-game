...
public class PSO
{
    ...
    private float c1_astronaut = DataBetweenScenes.getC1Astronaut();//1;    //1.5
    private float c2_astronaut = DataBetweenScenes.getC2Astronaut();//1.5f;       //2
    ...
    private float c1_alien = DataBetweenScenes.getC1Alien();//1;    //1.5
    private float c2_alien = DataBetweenScenes.getC2Alien();//1.5f;       //2
    ...
    {
        bool someAstronautGrounded = false;

        foreach (PlayerController controller in astronautControllers)
        {
            if (controller.isGrounded()) someAstronautGrounded = true;
        ...
        //Logs
        //if(someAstronautGrounded) globalBestScoreLogs_astronaut.Write(globalBestScore_astronaut);
    }
